...
def main():
    ...
    local_rank = int(os.environ.get("LOCAL_RANK", 0)) # BALKI: adding for multi gpu training - to set the device map
    ...
    bnb_config = BitsAndBytesConfig(
        ...
        bnb_4bit_use_double_quant=True, # BALKI: adding for multi gpu training -  to enable double quant and a lower‑memory compute dtype:
    ...
    # BALKI: Overwrite the Qwen template with a TRL-compatible ChatML template
    ...
    # BALKI: multi gpu training - letting the trainer handle FSDP synchronization and saving on its own
    ...
    # BALKI: multi gpu training - not saving the tokenizer on each rank as HF handles it automatically

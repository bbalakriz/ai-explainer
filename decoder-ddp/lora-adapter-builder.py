...
class MLflowLineageCallback(TrainerCallback):
    ...
    def on_train_begin(self, args, state, control, **kwargs):
        # only execute on the main process (Rank 0) to prevent DDP duplication
...
def main():
    ...
    parser.add_argument("--run_name", type=str, default="decoder-ddp-run-v1", help="mlflow run name, used in both SFTConfig and mlflow.start_run")
    ...
    # : multi gpu training - letting the trainer handle DDP synchronization and saving on its own
